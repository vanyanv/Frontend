...
describe('removeDuplicates', () => {
  it('should remove duplicates from array of numbers', () => {
    expect(removeDuplicates([1, 2, 2, 3, 4, 4, 5])).toEqual(
      [1, 2, 3, 4, 5].length
    );
  });
  ...
  it('should return same array when no duplicates exist', () => {
    expect(removeDuplicates([1, 2, 3, 4, 5])).toEqual([1, 2, 3, 4, 5].length);
  });

  it('should handle array with all duplicate values', () => {
    expect(removeDuplicates([1, 1, 1, 1])).toEqual([1].length);
  });
